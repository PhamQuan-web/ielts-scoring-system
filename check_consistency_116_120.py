...
input_files = ['batch_116.json', 'batch_117.json', 'batch_118.json', 'batch_119.json', 'batch_120.json']
...
if not scored_data:
    print("No scored data found for Batches 116-120!")
    exit(1)
...
print("Consistency Report (Batches 116-120):")
