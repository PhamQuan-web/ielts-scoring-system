...
input_files = ['batch_121.json', 'batch_122.json', 'batch_123.json', 'batch_124.json', 'batch_125.json']
...
if not scored_data:
    print("No scored data found for Batches 121-125!")
    exit(1)
...
print("Consistency Report (Batches 121-125):")
