...
input_files = ['batch_126.json', 'batch_127.json', 'batch_128.json', 'batch_129.json', 'batch_130.json']
...
if not scored_data:
    print("No scored data found for Batches 126-130!")
    exit(1)
...
print("Consistency Report (Batches 126-130):")
