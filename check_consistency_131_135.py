...
input_files = ['batch_131.json', 'batch_132.json', 'batch_133.json', 'batch_134.json', 'batch_135.json']
...
if not scored_data:
    print("No scored data found for Batches 131-135!")
    exit(1)
...
print("Consistency Report (Batches 131-135):")
