...
input_files = ['batch_136.json', 'batch_137.json', 'batch_138.json', 'batch_139.json', 'batch_140.json']
...
if not scored_data:
    print("No scored data found for Batches 136-140!")
    exit(1)
...
print("Consistency Report (Batches 136-140):")
