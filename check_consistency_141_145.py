...
input_files = ['batch_141.json', 'batch_142.json', 'batch_143.json', 'batch_144.json', 'batch_145.json']
...
if not scored_data:
    print("No scored data found for Batches 141-145!")
    exit(1)
...
print("Consistency Report (Batches 141-145):")
