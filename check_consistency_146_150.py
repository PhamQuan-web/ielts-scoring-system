...
input_files = ['batch_146.json', 'batch_147.json', 'batch_148.json', 'batch_149.json', 'batch_150.json']
...
if not scored_data:
    print("No scored data found for Batches 146-150!")
    exit(1)
...
print("Consistency Report (Batches 146-150):")
