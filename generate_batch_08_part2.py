...
# --- BATCH 08 PART 2: SAMPLES 671-690 (20 Total) ---
# Combo: V8/G8

# Sample 671: V8/G8 - Topic: Culture (Language)
samples.append(create_sample(
    ...
    grammar_reason="[GRA8] Wide range: 'The vocabulary we possess frames...', 'if a language has..., speakers might...', 'not merely..., it is...'. Error-free. >Band 7: Sophisticated structures.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 672: V8/G8 - Topic: Society (Volunteering)
samples.append(create_sample(
    index=672,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'For the community..., For the company...', 'However, it must be...', 'When done authentically...'. Error-free. >Band 7: Accurate and varied.",
    idiom_present=True,
    risk_level="medium"
))

# Sample 673: V8/G8 - Topic: Environment (Water)
samples.append(create_sample(
    index=673,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'leading to...', 'driving up...', 'faster than they can...', 'Unless we implement...'. Error-free. >Band 7: Complex sentence structures.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 674: V8/G8 - Topic: Transport (Safety)
samples.append(create_sample(
    index=674,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'Human error, such as...', 'accounts for...', 'While the roads will become...'. Majority error-free. >Band 7: Sophisticated control.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 675: V8/G8 - Topic: Education (Arts)
samples.append(create_sample(
    index=675,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'In an education system...', 'viewing them as...', 'It is a short-sighted strategy that...'. Error-free. >Band 7: Varied and accurate.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 676: V8/G8 - Topic: Technology (Space)
samples.append(create_sample(
    index=676,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'While it represents...', 'It seems indulgent for... to...', 'Unless the industry can...'. Error-free. >Band 7: Sophisticated structures.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 677: V8/G8 - Topic: Society (Media)
samples.append(create_sample(
    index=677,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'By selecting...', 'creating echo chambers', 'essential to avoid being...'. Majority error-free. >Band 7: Complex sentence structures.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 678: V8/G8 - Topic: Culture (Tradition)
samples.append(create_sample(
    index=678,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'Traditions that are...', 'risk being abandoned', 'while respecting...', 'It is a delicate balance between...'. Error-free. >Band 7: Sophisticated control.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 679: V8/G8 - Topic: Work (Remote)
samples.append(create_sample(
    index=679,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'When your home becomes...', 'The lack of... can stifle...', 'requires rigorous discipline'. Majority error-free. >Band 7: Varied structures.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 680: V8/G8 - Topic: Health (Diet)
samples.append(create_sample(
    index=680,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'leading to...', 'The cultural obsession... can morph...', 'It is a complex interplay of...'. Error-free. >Band 7: Sophisticated control.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 681: V8/G8 - Topic: Environment (Trees)
samples.append(create_sample(
    index=681,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'acting as a...', 'Beyond climate benefits...', 'which are irreplaceable...'. Majority error-free. >Band 7: Complex sentence structures.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 682: V8/G8 - Topic: Technology (Games)
samples.append(create_sample(
    index=682,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'have a profound impact on...', 'leading to addiction...', 'When used mindfully...'. Error-free. >Band 7: Sophisticated control.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 683: V8/G8 - Topic: Society (Cities)
samples.append(create_sample(
    index=683,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'As cities expand...', 'leading to...', 'focusing on...'. Majority error-free. >Band 7: Accurate and varied.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 684: V8/G8 - Topic: Transport (Safety)
samples.append(create_sample(
    index=684,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'By eliminating...', 'which accounts for...', 'where autonomous... share'. Error-free. >Band 7: Sophisticated structures.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 685: V8/G8 - Topic: Education (Reading)
samples.append(create_sample(
    index=685,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'is the bedrock of...', 'Conversely, widespread illiteracy...', 'is not just..., it is...'. Majority error-free. >Band 7: Complex sentence structures.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 686: V8/G8 - Topic: Culture (Global)
samples.append(create_sample(
    index=686,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'benefits from...', 'which fosters...', 'While integration poses...'. Error-free. >Band 7: Sophisticated control.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 687: V8/G8 - Topic: Work (Career)
samples.append(create_sample(
    index=687,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'opens doors to...', 'However, superficial networking...', 'based on...'. Majority error-free. >Band 7: Varied structures.",
    idiom_present=True,
    risk_level="medium"
))

# Sample 688: V8/G8 - Topic: Technology (Communication)
samples.append(create_sample(
    index=688,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'It is becoming...', 'would require disconnecting...', 'which is impractical'. Error-free. >Band 7: Sophisticated control.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 689: V8/G8 - Topic: Society (Housing)
samples.append(create_sample(
    index=689,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'It represents a failure...', 'often exceeds...', 'is judged by how...'. Majority error-free. >Band 7: Accurate complex sentences.",
    idiom_present=True,
    risk_level="medium"
))

# Sample 690: V8/G8 - Topic: Transport (Flying)
samples.append(create_sample(
    index=690,
    vocab_band=8,
    grammar_band=8,
    ...
    grammar_reason="[GRA8] Wide range: 'Where high-speed rail exists...', 'banning flights makes sense', 'a ban would isolate'. Error-free. >Band 7: Sophisticated structures.",
    idiom_present=False,
    risk_level="medium"
))
