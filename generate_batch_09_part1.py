...
# --- BATCH 09 PART 1: SAMPLES 731-750 (20 Total) ---
# Combo: V8/G9 (Very Good Vocab, Expert Grammar)

# Sample 731: V8/G9 - Topic: Environment (Sustainability)
samples.append(create_sample(
    index=731,
    vocab_band=8,
    grammar_band=9,
    question="Why is sustainable development important?",
    transcript="It is imperative for the longevity of our planet. Were we to continue depleting finite resources at the current rate, we would jeopardize the well-being of future generations. Sustainable development strikes a balance between economic growth and environmental preservation. It ensures that we meet our current needs without compromising the ability of our descendants to meet theirs. Transitioning to a green economy is not merely an option; it is an absolute necessity.",
    response_type="extended",
    micro_flaws=[],
    grammar_profile={"complexity": "high", "accuracy": "high", "flexibility": "high"},
    vocab_reason="[LR8] Uses sophisticated items: 'imperative', 'longevity', 'depleting', 'finite', 'jeopardize', 'strikes a balance', 'compromising', 'descendants'. >Band 7: Precise and varied. Not Band 9: Lacks full native-like flow.",
    grammar_reason="[GRA9] Full range of structures used with complete accuracy. 'Were we to continue...' (inversion), 'It ensures that we meet...'. Error-free.",
    idiom_present=True,
    risk_level="low"
))

# Sample 732: V8/G9 - Topic: Technology (AI)
samples.append(create_sample(
    index=732,
    vocab_band=8,
    grammar_band=9,
    question="Will AI surpass human intelligence?",
    transcript="It is a distinct possibility that has experts divided. While AI currently excels at specialized tasks, achieving general artificial intelligence remains elusive. However, the exponential growth in computing power suggests we might reach a singularity sooner than anticipated. Should machines develop consciousness, the implications for humanity would be profound. We must tread carefully, ensuring that ethical frameworks evolve alongside technological advancements.",
    response_type="extended",
    micro_flaws=[],
    grammar_profile={"complexity": "high", "accuracy": "high", "flexibility": "high"},
    ...
    grammar_reason="[GRA9] Full range of structures used naturally and accurately. 'Should machines develop consciousness...' (inversion). Error-free.",
    idiom_present=True,
    risk_level="medium"
))

# Sample 733: V8/G9 - Topic: Education (University)
samples.append(create_sample(
    index=733,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used with precision. 'leaving many graduates...', 'Ideally, education should be...'. Error-free.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 734: V8/G9 - Topic: Society (Inequality)
samples.append(create_sample(
    index=734,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used effortlessly. 'but not an insurmountable one', 'While complete eradication might be...'. Error-free.",
    idiom_present=True,
    risk_level="medium"
))

# Sample 735: V8/G9 - Topic: Culture (Globalization)
samples.append(create_sample(
    index=735,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used accurately. 'not just physical monuments', 'integrating... ensures that...', 'by celebrating...'. Error-free.",
    idiom_present=True,
    risk_level="medium"
))

# Sample 736: V8/G9 - Topic: Work (Job)
samples.append(create_sample(
    index=736,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used with precision. 'Employees who feel...', 'companies must pivot...', 'success stems from...'. Error-free.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 737: V8/G9 - Topic: Transport (Cities)
samples.append(create_sample(
    index=737,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used effortlessly. 'The convergence... will transform...', 'shift from... to...', 'realizing this vision requires...'. Error-free.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 738: V8/G9 - Topic: Health (Exercise)
samples.append(create_sample(
    index=738,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used with complete accuracy. 'create an obesogenic environment', 'a survival mechanism that is...', 'Breaking these habits requires...'. Error-free.",
    idiom_present=True,
    risk_level="medium"
))

# Sample 739: V8/G9 - Topic: Environment (Wildlife)
samples.append(create_sample(
    index=739,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used naturally. 'Despite international bans...', 'making enforcement difficult', 'drives locals to participate'. Error-free.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 740: V8/G9 - Topic: Education (Reading)
samples.append(create_sample(
    index=740,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used with precision. 'It forces the reader to...', 'Unlike passive media...', 'challenging our preconceived notions'. Error-free.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 741: V8/G9 - Topic: Technology (Data)
samples.append(create_sample(
    index=741,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used naturally. 'which corporations harvest...', 'declaring it a lost cause is...', 'The battle... is ongoing'. Error-free.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 742: V8/G9 - Topic: Society (Volunteer)
samples.append(create_sample(
    index=742,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used with complete accuracy. 'While incentives might...', 'If people volunteer...', 'without commodifying it'. Error-free.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 743: V8/G9 - Topic: Culture (Art)
samples.append(create_sample(
    index=743,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used effortlessly. 'It has the power to...', 'by allowing us to...', 'It is not merely..., it is...'. Error-free.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 744: V8/G9 - Topic: Work (Gender)
samples.append(create_sample(
    index=744,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used with precision. 'Despite progress...', 'due to...', 'Achieving true equality requires...'. Error-free.",
    idiom_present=True,
    risk_level="medium"
))

# Sample 745: V8/G9 - Topic: Transport (Flying)
samples.append(create_sample(
    index=745,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used naturally. 'making it accessible...', 'However, the race...', 'While beneficial..., the...'. Error-free.",
    idiom_present=True,
    risk_level="medium"
))

# Sample 746: V8/G9 - Topic: Education (Technology)
samples.append(create_sample(
    index=746,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used with complete accuracy. 'When used indiscriminately...', 'If technology is woven...', 'rather than replace...'. Error-free.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 747: V8/G9 - Topic: Society (Housing)
samples.append(create_sample(
    index=747,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used naturally. 'For many, it is...', 'Consequently, an entire generation...', 'Unless there is...'. Error-free.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 748: V8/G9 - Topic: Environment (Trees)
samples.append(create_sample(
    index=748,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used with precision. 'such as...', 'sends a strong signal', 'has proven effective'. Error-free.",
    idiom_present=False,
    risk_level="medium"
))

# Sample 749: V8/G9 - Topic: Technology (Social Media)
samples.append(create_sample(
    index=749,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used effortlessly. 'designed to trigger...', 'keeping users engaged...', 'Recognizing... is the first step'. Error-free.",
    idiom_present=True,
    risk_level="medium"
))

# Sample 750: V8/G9 - Topic: Work (Job Hopping)
samples.append(create_sample(
    index=750,
    vocab_band=8,
    grammar_band=9,
    ...
    grammar_reason="[GRA9] Full range of structures used with complete accuracy. 'It used to be..., signaling...', 'without staying long enough...', 'The key is to...'. Error-free.",
    idiom_present=True,
    risk_level="medium"
))
