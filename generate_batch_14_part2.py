...
# --- BATCH 14 PART 2: SAMPLES 1203-1244 (42 Total) ---
# Combo: V9/G6 (Expert Vocab, Mixed Grammar)
# Strategy: Use Band 9 vocabulary (idiomatic, precise, sophisticated) but make frequent Band 6 grammar errors (mix of simple/complex, but errors persist).

topics_14_2 = [
    {
        "question": "Is fast fashion bad?",
        "transcript": "The ephemeral nature of fast fashion is detrimental to the environment. It fosters a disposable culture that exacerbates waste. I thinks that consumers is becoming more conscious. However, the allure of cheap clothing remain potent. We must curbing our insatiable appetite for new trends. Sustainable alternatives is gaining traction, but the industry need a paradigm shift.",
        "micro_flaws": ["Subject-verb agreement error: 'consumers is'", "Subject-verb agreement error: 'clothing remain'", "Verb form error: 'must curbing'", "Subject-verb agreement error: 'alternatives is'", "Subject-verb agreement error: 'industry need'"],
        "vocab_reason": "[LR9] Sophisticated vocab: 'ephemeral', 'detrimental', 'fosters', 'exacerbates', 'insatiable appetite', 'paradigm shift'. >Band 8: Natural and precise.",
        "grammar_reason": "[GRA6] Mixed range: 'consumers is' (S-V), 'must curbing' (modal+gerund), 'remain' (S-V). >Band 5: Better control of complex vocab than grammar."
    },
    {
        "question": "Will AI rule?",
        "transcript": "Artificial intelligence is poised to revolutionize every facet of our existence. Its potential to augment human capabilities is unprecedented. However, the ethical ramifications is profound. If we unleashes this technology without oversight, the consequences is dire. We stands at a precipice. It is imperative that we navigates this transition with prudence.",
        "micro_flaws": ["Subject-verb agreement error: 'ramifications is'", "Subject-verb agreement error: 'we unleashes'", "Subject-verb agreement error: 'consequences is'", "Subject-verb agreement error: 'We stands'", "Subject-verb agreement error: 'we navigates'"],
        "vocab_reason": "[LR9] High-level items: 'poised to revolutionize', 'facet', 'augment', 'unprecedented', 'ethical ramifications', 'precipice', 'prudence'. >Band 8: Precise.",
        "grammar_reason": "[GRA6] Errors: 'is' (plural), 'unleashes', 'stands', 'navigates'. >Band 5: Meaning clear despite errors."
    },
    {
        "question": "Why study art?",
        "transcript": "Art is the quintessential expression of the human spirit. It transcends cultural boundaries and evokes visceral emotions. A world without art would be devoid of soul. However, funding for the arts are often cut. This philistine attitude undermine our cultural heritage. We must champions creativity as a cornerstone of civilization.",
        "micro_flaws": ["Subject-verb agreement error: 'arts are' (funding is)", "Subject-verb agreement error: 'attitude undermine'", "Verb form error: 'must champions'"],
        "vocab_reason": "[LR9] Vocab: 'quintessential', 'transcends', 'visceral emotions', 'devoid', 'philistine', 'cornerstone'. >Band 8: Idiomatic.",
        "grammar_reason": "[GRA6] Errors: 'are' (subject funding), 'undermine', 'champions'. >Band 5: Attempts complex structures."
    },
    {
        "question": "Is privacy lost?",
        "transcript": "In this digital panopticon, privacy has become an antiquated concept. Surveillance capitalism thrives on our data. We unwittingly signs away our rights. The encroachment on our personal lives are alarming. Encryption offer a semblance of protection. But the erosion of civil liberties seem inevitable.",
        "micro_flaws": ["Subject-verb agreement error: 'We signs'", "Subject-verb agreement error: 'encroachment... are'", "Subject-verb agreement error: 'Encryption offer'", "Subject-verb agreement error: 'erosion... seem'"],
        "vocab_reason": "[LR9] Vocab: 'digital panopticon', 'antiquated', 'surveillance capitalism', 'unwittingly', 'encroachment', 'semblance', 'erosion'. >Band 8: Very sophisticated.",
        "grammar_reason": "[GRA6] Errors: 'signs', 'are' (singular subject), 'offer', 'seem'. >Band 5: Frequent errors."
    },
    {
        "question": "How to fix cities?",
        "transcript": "Urban sprawl is a blight on our landscape. We must embrace high-density living to mitigate environmental impact. Gentrification often displace the vulnerable. We needs inclusive zoning laws. Green spaces acts as the lungs of the city. Revitalizing infrastructure are essential for a sustainable future.",
        "micro_flaws": ["Subject-verb agreement error: 'Gentrification... displace'", "Subject-verb agreement error: 'We needs'", "Subject-verb agreement error: 'spaces acts'", "Subject-verb agreement error: 'infrastructure are'"],
        "vocab_reason": "[LR9] Vocab: 'urban sprawl', 'blight', 'mitigate', 'gentrification', 'inclusive zoning', 'revitalizing'. >Band 8: Precise and natural.",
        "grammar_reason": "[GRA6] Errors: 'displace', 'needs', 'acts', 'are'. >Band 5: Communication effective but grammatically flawed."
    },
    {
        "question": "Is sleep vital?",
        "transcript": "Sleep is the bedrock of physiological health. Chronic deprivation wreaks havoc on the immune system. In our hyper-connected world, rest is often marginalized. We treats sleep as a luxury. This mindset are detrimental. We must prioritizes circadian rhythms. Only then can we functions at our peak.",
        ...
        "vocab_reason": "[LR9] Vocab: 'bedrock', 'physiological', 'wreaks havoc', 'hyper-connected', 'marginalized', 'circadian rhythms'. >Band 8: Sophisticated.",
        "grammar_reason": "[GRA6] Errors: 'treats', 'are', 'prioritizes', 'functions'. >Band 5: Errors persist."
    },
    {
        "question": "Why travel?",
        "transcript": "Travel broadens the mind and fosters cross-cultural empathy. It allow us to escape the mundane. Immersing oneself in a foreign culture is transformative. However, tourism can leads to commodification. Authentic experiences is becoming rare. We should seeks to be travelers, not tourists.",
        ...
        "vocab_reason": "[LR9] Vocab: 'fosters', 'cross-cultural empathy', 'mundane', 'transformative', 'commodification', 'authentic'. >Band 8: Idiomatic.",
        "grammar_reason": "[GRA6] Errors: 'allow', 'leads', 'is', 'seeks'. >Band 5: Frequent errors."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'bestow', 'dismantles', 'thrives'. >Band 5: Clear meaning."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'stimulate', 'needs', 'illuminate'. >Band 5: Good range but errors."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'has', 'require', 'offers', 'are'. >Band 5: Frequent errors."
    }
]

# Expanding to 42 samples
more_topics_14_2 = [
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'allow', 'is', 'resists', 'evolves'. >Band 5: Clear."
    },
    {
        "question": "Why work?",
        ...
        "grammar_reason": "[GRA6] Errors: 'erode', 'reimagines'. >Band 5: Errors persist."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'is' (plural), 'values'. >Band 5: Good range."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'inspire', 'becomes', 'depend'. >Band 5: Frequent errors."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'evokes', 'need'. >Band 5: Clear."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'provide', 'scrutinizes'. >Band 5: Good."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'transcends', 'breed', 'strikes'. >Band 5: Errors."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'bombard', 'has', 'reclaims'. >Band 5: Clear."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'cloud', 'learns'. >Band 5: Good."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'needs'. >Band 5: Clear."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'poison', 'releases'. >Band 5: Good."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'killed', 'balances'. >Band 5: Clear."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'prevent', 'questions'. >Band 5: Good."
    },
    {
        "question": "Why dream?",
        ...
        "grammar_reason": "[GRA6] Errors: 'sees', 'chases'. >Band 5: Clear."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'adheres', 'require'. >Band 5: Good."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'paralyze', 'confronts'. >Band 5: Clear."
    },
    {
        "question": "Why regret?",
        ...
        "grammar_reason": "[GRA6] Errors: 'learns', 'looks'. >Band 5: Good."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'becomes', 'needs'. >Band 5: Clear."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'requires', 'fade', 'nurtures'. >Band 5: Good."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'changes', 'spreads'. >Band 5: Clear."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'creates', 'seeks'. >Band 5: Good."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'influences', 'chooses', 'focuses'. >Band 5: Clear."
    },
    {
        "question": "Why write?",
        ...
        "grammar_reason": "[GRA6] Errors: 'has', 'inspires', 'writes'. >Band 5: Good."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'learns'. >Band 5: Clear."
    },
    {
        "question": "Why hope?",
        ...
        "grammar_reason": "[GRA6] Errors: 'holds', 'shape'. >Band 5: Good."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'takes', 'defends'. >Band 5: Clear."
    },
    {
        "question": "Why laugh?",
        ...
        "grammar_reason": "[GRA6] Errors: 'laughs'. >Band 5: Good."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'yields', 'strives'. >Band 5: Clear."
    },
    {
        "question": "Why exist?",
        ...
        "grammar_reason": "[GRA6] Errors: 'seeks', 'embraces'. >Band 5: Good."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'shapes', 'seized'. >Band 5: Clear."
    },
    {
        "question": "Why create?",
        ...
        "grammar_reason": "[GRA6] Errors: 'nurtures'. >Band 5: Good."
    },
    {
        ...
        "grammar_reason": "[GRA6] Errors: 'communicates', 'respects'. >Band 5: Clear."
    }
]

full_topics_14_2 = topics_14_2 + more_topics_14_2 # Total 42

start_index = 1203
for i, item in enumerate(full_topics_14_2):
